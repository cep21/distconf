...
Explain why (not how) someone would want to use this code.  This should be a bit of a sales pitch.  Use distconf to
...
[example test file](./distconf_example_test.go).

<!--
```go
    func ExampleRemoveMe() {
    	fmt.Println(distconf.RemoveMe("hello", "world"))
    }
```
-->
To use distconf:
1. Visit the generation URL for distconf at https://github.com/cep21/distconf/generate and create your repository.
...
3. Rename cep21/distconf to your repository.  There is a makefile helper this, which expects an OWNER
...
I really like [testable examples](./distconf_example_test.go) as code documentation that verifies itself as correct (unlike actual documentation blocks
